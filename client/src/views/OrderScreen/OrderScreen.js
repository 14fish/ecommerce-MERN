...
import {
  ...
  payOrder,
  deliverOrder,
} from '../../_actions/orderActions.js';
import { Loader, Message } from '../../components';
import { PayPalButton } from 'react-paypal-button-v2';
import {
  ORDER_PAY_RESET,
  ORDER_DELIVER_RESET,
} from '../../_constants/orderConstants.js';
...
export const OrderScreen = ({ match, history }) => {
  ...
  useEffect(() => {
    ...
    if (!order || succesPay || successDeliver) {
  ...
  }, [dispatch, orderId, succesPay, order, error, successDeliver, history, userInfo]);
  ...
  return loading ? (
    ...
    <Message variant='flush'>{error}</Message>
  ) : (
    <>
